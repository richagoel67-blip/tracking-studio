...
function Dashboard() {
  return (
    <div className="min-h-screen bg-canvas text-foreground text-sm font-sans antialiased">
      ...
      <div className="flex">
        <aside className="min-h-[calc(100vh-4rem)] w-60 shrink-0 border-r border-border bg-white">
          <div className="flex items-center gap-2 px-6 pb-2 pt-6">
            <ArrowLeft className="size-6 text-foreground" strokeWidth={1.5} />
          ...
          <nav className="flex flex-col gap-1 px-4 pb-8 pt-4">
            <SideItem active icon={<LayoutDashboard className="size-5" />} label="Dashboard" />
            <SideItem icon={<NavRouteIcon className="size-5" />} label="Test mode/Debug" />
            <NavSectionLabel label="ATS" />
            <SideItem icon={<User className="size-5" />} label="Candidates" />
            <SideItem icon={<Users className="size-5" />} label="ATS Library" />
            <SideItem icon={<Megaphone className="size-5" />} label="Campaigns" />
            <NavSectionLabel label="Workspace" />
            <SideItem icon={<Code2 className="size-5" />} label="Snippets" />
            <SideItem icon={<MessageSquare className="size-5" />} label="Discussion" />
            <SideItem icon={<Headphones className="size-5" />} label="Support" badge />
            <NavSectionLabel label="Configuration" />
            <SideItem icon={<Tv className="size-5" />} label="Tracking pixels" />
            <SideItem icon={<FileEdit className="size-5" />} label="Content" />
            <SideItem icon={<Bot className="size-5" />} label="Automation" />
            <SideItem icon={<BookOpen className="size-5" />} label="Documentation" />
            <SideItem icon={<QrCode className="size-5" />} label="QR toolkit" />
            <NavSectionLabel label="Integrate" />
            <SideItem icon={<Store className="size-5" />} label="Partner hub" badge />
            <SideItem icon={<Activity className="size-5" />} label="Diagnostics" />
          </nav>
        </aside>

        <main className="min-w-0 flex-1 p-6">
          <div className="mx-auto max-w-[1148px] space-y-5">
            <div>
              ...
              <p className="mt-2 text-sm leading-5 text-[color:var(--figma-gray-text-03)]">
                Track funnel performance, attribution quality, and pixel health across devices and ATS integrations.
              </p>
            </div>
            ...
            <section className="rounded-lg border border-border bg-white p-6">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="flex flex-wrap items-center gap-3">
                  <span className="text-lg font-semibold leading-7 text-foreground">Tenet Healthcare</span>
                  ...
                  <div className="flex items-center gap-1">
                    <span className="text-xs leading-[18px] text-[color:var(--figma-gray-text-03)]">Pixel Status</span>
              ...
              <div className="mt-4 flex flex-wrap items-center gap-8 lg:gap-12">
                <div className="flex items-center gap-1 text-xs leading-[18px]">
                  <Clock className="size-[18px] text-[color:var(--figma-success-main)]" strokeWidth={1.5} />
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs leading-[18px] text-[color:var(--figma-gray-text-03)]">Primary contact</span>
                  <div className="flex items-center gap-1">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs leading-[18px] text-[color:var(--figma-gray-text-03)]">Implementation progress</span>
                  <span className="text-sm font-semibold leading-5 text-foreground">94%</span>
                  <svg className="size-5 -rotate-90" viewBox="0 0 36 36">
                    <circle cx="18" cy="18" r="15.5" fill="none" stroke="var(--figma-gray-border-03)" strokeWidth="3" />
                    <circle
                      cx="18"
                      cy="18"
                      r="15.5"
            ...
            <section className="flex flex-col gap-4 lg:flex-row lg:items-stretch">
              <div className="flex h-[178px] w-full shrink-0 flex-col justify-between rounded-lg border border-border bg-white p-6 lg:w-[200px]">
                <div>
                  <div className="text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">Total events</div>
                  <div className="mt-1 text-lg font-bold leading-none text-foreground">4,094</div>
                  <div className="mt-1 text-xs leading-[18px] text-[color:var(--figma-success-main)]">+12.3% from last period</div>
                </div>
              ...
              <div className="flex min-h-[178px] min-w-0 flex-1 gap-8 rounded-lg border border-border bg-white p-6">
                <div className="flex h-full flex-col justify-between">
                  <div>
                    <div className="text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">Attribution coverage</div>
                    <div className="mt-1 flex items-end gap-1">
                      <span className="text-lg font-semibold leading-7 text-foreground">94%</span>
                      <span className="pb-0.5 text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">/6% unattributed</span>
                    </div>
                  </div>
                  <div className="w-[234px] max-w-full space-y-2">
                    <div className="flex justify-between text-xs leading-[18px]">
                      <span>
                        ...
                        <span className="font-normal text-[color:var(--figma-gray-text-04)]">Cookie</span>
                      </span>
                      <span>
                        <span className="font-semibold text-foreground">22%</span>{" "}
                        <span className="font-normal text-[color:var(--figma-gray-text-04)]">fingerprint</span>
                      </span>
                    </div>
                ...
                <div className="flex min-w-0 flex-1 flex-col justify-between gap-6">
                  <div className="flex flex-wrap gap-6">
                    <div className="flex gap-6">
                      <div className="flex flex-col justify-between gap-3">
                        <div className="flex items-center gap-1">
                          <Monitor className="size-[18px] text-[color:var(--figma-gray-text-04)]" strokeWidth={1.5} />
                          <span className="text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">Desktop split</span>
                        </div>
                  ...
                  <div className="flex flex-wrap gap-6">
                    <div className="flex gap-6">
                      <div className="flex flex-col justify-between gap-3">
                        <div className="flex items-center gap-1">
                          <Smartphone className="size-[18px] text-[color:var(--figma-gray-text-04)]" strokeWidth={1.5} />
                          <span className="text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">Mobile split</span>
                        </div>
              ...
              <div className="flex min-h-[178px] flex-1 rounded-lg border border-border bg-white p-6 lg:max-w-[302px] lg:flex-none">
                <div className="flex w-full justify-between gap-6">
                  <div className="flex flex-col justify-between gap-5">
                    <div>
                      <div className="text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">Pixel health</div>
                      <div className="mt-0.5 flex items-end gap-1">
                        <span className="text-lg font-semibold leading-7 text-foreground">47/52</span>
                        <span className="pb-0.5 text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">healthy</span>
                      </div>
                    </div>
                    <div className="space-y-2 text-xs leading-[18px] text-[color:var(--figma-gray-text-04)]">
                      ...
                      <div className="flex items-center gap-2.5">
                        <span className="h-2 w-4 shrink-0 rounded-lg bg-chart-bar" />
                        3 Warning
                      </div>
                      <div className="flex items-center gap-2.5">
                        <span className="h-2 w-4 shrink-0 rounded-lg bg-chart-bar-muted" />
                        2 Silent
                      </div>
                    </div>
                  </div>
            ...
            <section className="flex flex-col gap-5 lg:flex-row lg:items-stretch">
              <div className="flex min-h-[360px] flex-1 flex-col rounded-md border border-[color:var(--figma-neutral-300)] bg-white p-6 lg:max-w-[782px]">
                <h2 className="text-base font-medium leading-[30px] text-[color:var(--figma-title-strong)]">Conversion funnel</h2>
              ...
              <div className="flex w-full flex-col rounded-lg border border-border bg-white p-6 lg:w-[346px] lg:shrink-0">
                <h3 className="text-sm font-semibold leading-5 text-[color:var(--figma-gray-text-04)]">Pixel status</h3>
...
const rows = [
  { os: "Windows", browser: "Chrome", clicks: "1.1M", views: "3.3k", start: "40k", finish: "40k", cf: "4k", mobile: false },
  { os: "iOS", browser: "Safari", clicks: "3.3k", views: "1.1M", start: "3k", finish: "3k", cf: "300", mobile: true },
  { os: "Android", browser: "Firefox", clicks: "4k", views: "3.3k", start: "201k", finish: "201k", cf: "200", mobile: true },
  { os: "Linux", browser: "Edge", clicks: "3.3k", views: "3.3k", start: "6k", finish: "6k", cf: "600", mobile: false },
  { os: "macOS", browser: "Opera", clicks: "3.3k", views: "201k", start: "3.3k", finish: "3.3k", cf: "340", mobile: false },
  { os: "Chrome OS", browser: "Brave", clicks: "3.3k", views: "4k", start: "3.0k", finish: "3.0k", cf: "1k", mobile: false },
  { os: "Ubuntu", browser: "Vivaldi", clicks: "201k", views: "3.3k", start: "4k", finish: "4k", cf: "2k", mobile: false },
];

function NavSectionLabel({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-2 px-3 py-2">
      <span className="text-xs font-medium text-[color:var(--figma-gray-text-03)]">{label}</span>
      <div className="h-px flex-1 bg-[color:var(--figma-line-icon)]" />
    </div>
  );
}
...
function SideItem({
  ...
  return (
    <button
      type="button"
      className={`flex w-full items-center gap-2 rounded-md py-2 pl-3 pr-2 text-left text-sm leading-5 transition-colors ${
        active
          ? "bg-[color:var(--figma-primary-lighter)] font-semibold text-primary"
          : "font-normal text-[color:var(--figma-gray-text-04)] hover:bg-[color:var(--figma-gray-bg-03)]"
      }`}
    >
      <span className={active ? "text-primary" : "text-[color:var(--figma-gray-icon-04)]"}>{icon}</span>
      <span className="flex-1">{label}</span>
      {badge ? <span className="size-1.5 rounded-full bg-[color:var(--figma-secondary-main)]" /> : null}
    </button>
  );
}
...
function FunnelStep({ label, value, sub }: { label: string; value: string; sub?: string }) {
  return (
    <div>
      <div className="text-sm font-medium leading-5 text-[color:var(--figma-funnel-label)]">{label}</div>
      <div className="mt-1 text-base font-semibold leading-6 text-[color:var(--figma-title-strong)]">{value}</div>
      {sub ? <div className="mt-2 text-sm font-normal leading-normal text-[color:var(--figma-funnel-sub)]">{sub}</div> : null}
    </div>
  );
}
...
function PixelRow({ tag, tagClass, type }: { tag: string; tagClass: string; type: string }) {
  return (
    <div className="space-y-2">
      <div className="flex flex-wrap items-center gap-2">
        <span className={`rounded-full px-1.5 py-0.5 text-xs font-medium leading-[18px] ${tagClass}`}>{tag}</span>
...
function Td({ children, right }: { children: React.ReactNode; right?: boolean }) {
  return (
    <td className={`border-border px-6 py-4 ${right ? "text-right" : "text-left"} text-sm leading-5 text-foreground`}>{children}</td>
  );
}
